angular.module("umbraco.directives").directive('uiTextareaMaxchar', function ($timeout, notificationsService, localizationService, bpeHelperService) {
    return {
        restrict: 'EA',
        replace: true,
        templateUrl: '/App_Plugins/BasicPropertyEditors/Directives/UiTextareaMaxchar/UiTextareaMaxchar.html',
        require: 'ngModel',
        scope: {
            ngModel: '=ngModel',
            cutText: '@cutText',
